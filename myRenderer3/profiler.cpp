...
//    for (uint32_t i = 0; i < frameCircBuf->getSizeCircBuf(); ++i)
//    {
//        get each vector of a frame
//        Array<Profile> fpVec = *((Array*)getCircBufAt(&frameCircBuf, i));
//        Array<Profile>* fpVec = (Array<Profile>*)frameCircBuf->getCircBufAt(i);
//        freeArray(&fpVec);
//        delete fpVec;
//    }
//
